    ...
    async function fetchData() {
      try {
        ...
        const brandIcons: Record<string, string> = {
          ...
          dell: '💻', nintendo: '🎮', whoop: '⌚', lego: '🧱', 'fujifilm instax': '📷',
        }
          ...
          const apiCategories: CatalogCategory[] = catData
            ...
            .map(c => {
              ...
              return {
                ...
                // Единственный источник быстрых фильтров — quick_filters категории из API.
                // Пустой список = полоска моделей не рендерится (гейт на length > 0 ниже).
