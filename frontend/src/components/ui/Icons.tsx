...
export function HeadphonesIcon({ className = 'h-8 w-8' }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function WatchIcon({ className = 'h-8 w-8' }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
    </svg>
...
export function TabletIcon({ className = 'h-8 w-8' }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function GamepadIcon({ className = 'h-8 w-8' }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function PlugIcon({ className = 'h-8 w-8' }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function VkIcon({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
      <path d="M15.073 2H8.938C3.332 2 2 3.333 2 8.927v6.136C2 20.667 3.323 22 8.927 22h6.136C20.667 22 22 20.677 22 15.073V8.938C22 3.332 20.667 2 15.073 2zM18.66 16.6h-1.773c-.667 0-.875-.532-2.073-1.76-1.042-1.01-1.5-1.146-1.755-1.146-.365 0-.469.104-.469.604v1.604c0 .427-.136.688-1.26.688-1.854 0-3.917-1.125-5.365-3.219C4.04 10.657 3.5 8.658 3.5 8.167c0-.26.104-.5.604-.5h1.771c.448 0 .615.198.79.667.854 2.478 2.291 4.646 2.885 4.646.22 0 .323-.103.323-.667V10.01c-.062-1.198-.698-1.303-.698-1.73 0-.208.166-.417.437-.417h2.782c.375 0 .5.198.5.635v3.417c0 .375.156.5.271.5.219 0 .417-.125.833-.542 1.292-1.458 2.219-3.708 2.219-3.708.125-.26.323-.5.77-.5h1.772c.531 0 .656.271.531.635-.229 1.073-2.479 4.24-2.479 4.24-.198.323-.271.469 0 .833.198.271.854.833 1.291 1.344.802.906 1.417 1.667 1.583 2.188.167.521-.104.792-.604.792z"/>
    </svg>
  )
}
